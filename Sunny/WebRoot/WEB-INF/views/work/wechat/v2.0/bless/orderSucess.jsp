...
<html>
  <head>
    ...
    <title>制作成功-${config.siteName}</title>
...
.bar-menus-button {
    ...
    <style type="text/css"> 
.card-mobile { 
background: url('${config.imgDomainName}/${image.folder }/${image.name }_y1080.jpg'); 
background-size:
 100%;
            ...
            <div class="content content-clear-top">
               ...
               <script type="text/javascript">
	             //朋友分享 参数
	               ...
	               com_shareAppMessage_imgUrl='${config.imgDomainName}/${image.folder }/${image.name }_100x100.jpg';
