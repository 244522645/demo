...
import wechat.bean.paymch.Closeorder;
import wechat.bean.paymch.MchBaseResult;
import wechat.bean.paymch.MchShorturl;
import wechat.bean.paymch.MchShorturlResult;
import wechat.bean.paymch.Refundquery;
import wechat.bean.paymch.RefundqueryResult;
import wechat.bean.paymch.SecapiPayRefund;
import wechat.bean.paymch.SecapiPayRefundResult;
import wechat.bean.paymch.Unifiedorder;
import wechat.bean.paymch.UnifiedorderResult;
import wechat.client.LocalHttpClient;
import wechat.util.MapUtil;
import wechat.util.SignatureUtil;
