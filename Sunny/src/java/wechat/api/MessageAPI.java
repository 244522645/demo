...
import wechat.bean.Article;
import wechat.bean.BaseResult;
import wechat.bean.Media;
import wechat.bean.MessageSendResult;
import wechat.bean.Uploadvideo;
import wechat.bean.massmessage.MassMessage;
import wechat.bean.message.Message;
import wechat.bean.templatemessage.TemplateMessage;
import wechat.bean.templatemessage.TemplateMessageResult;
