...
import wechat.bean.pay.PayJsRequest;
import wechat.bean.pay.PayNativeReply;
import wechat.bean.pay.PayNativeRequest;
import wechat.bean.pay.PayPackage;
import wechat.bean.paymch.MchPayNativeReply;
...
public class PayUtil {
	 ...
	 * @return
	 */
	public static String generatePaySign(
			String appid,
			String mch_id,
			String productid,
			String key){
