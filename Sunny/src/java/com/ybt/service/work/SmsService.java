...
@Component
public interface SmsService  extends IBaseService<SunGySms, String>{
	/**
	 * 保存信息
	 * @param sms 短信对象
	 * @return SunGySms 信息
	 ...
	 *@history 修订历史（历次修订内容、修订人、修订时间等）
	 */
	SunGySms sendSmsCode(VerCodeBean verCodeBean,String content);
	/**
	 *@name    发送短信提醒
	 *@description 根据类型不同发送不同的格式验证信息 
	 *@param verCodeBean
	 ...
	 *@history 修订历史（历次修订内容、修订人、修订时间等）
	 */
	SunGySms sendOrderWarn(VerCodeBean verCodeBean,String content);
	 ...
	 *@history 修订历史（历次修订内容、修订人、修订时间等）
	 */
	SunGySms sendPhotoDownRequest(String phone,String photoIinfo,String userInfo);
