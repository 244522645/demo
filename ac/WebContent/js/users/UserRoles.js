			...
			.each(
					...
					function(i, v) {
						...
						if (!v.rightascription) {
							td1 = "<td style='width:9%;border:solid 1px #add9c0;background: rgb(197, 213, 213) none repeat scroll 0% 0%;'><input id="
									+ v.rightId
									...
									.each(
											...
											function(p, o) {
												if (v.rightId == o.rightascription) {
													tr1
															.append("<td style='width:9%;border:solid 1px #add9c0;background: rgb(177, 219, 242) none repeat scroll 0% 0%;'><input id="
																	+ o.rightId
