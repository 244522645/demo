...
function selectUser() {
	$.post("./KUser/findByUser.do", function(data) {
		...
		if(userType==2){
			...
			$("#zhu").css({height:"50px"});
			$("#zhu").html("<span style='color: rgb(245, 29, 29); font-size: 25px;'>您的余额为:"+balance+"元</span>");
		}
	});
...
function addInfo() {
	...
	$("#openCard").form('submit', {
		url : './KCardOrders/addCardOrders.do',
