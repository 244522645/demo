...
<script type="text/javascript" src="<%=path%>/js/card/payCard.js"
...
<body class="easyui-layout" style="font: 16px Microsoft YaHei" oncontextmenu="return false" onselectstart="return false">
	<div data-options="region:'north',border:false,collapsible:false,"
		...
		<div
			...
			align="center">
			<span
				style="font-size: 20px; margin-left: 20px; color: rgb(255, 0, 0);">充值单填写</span>
		</div>
		<div id="dlgSave"
				...
				<div style="width: 90%; height: 90px; overflow: auto;" id="zhu"
					...
					<span><span
						...
						style="color: rgb(245, 29, 29);">当前账户可用余额计算方法:<span
							...
							开卡和卡充值已经分开，此页只是充值页，如果想开卡请点击左面“开卡”。
					</span></span>
				</div>
				<div
					style="background: rgb(103, 203, 199) none repeat scroll 0% 0%; height: 30px; width: 100%;"
					align="left">
					<span style="font-size: 20px; margin-left: 20px;">一、充值卡、电子券：</span>
				</div>
						...
						<table>
							...
							<tr>
								...
								<td><input type="text" id="add_dianShu" name="dianShu"
									...
									onblur="countDate(this)" /><span
									id="add_dianShuUnit">(点/张)</span></td>
								<td rowspan="1"></td>
							...
							<tr>
								...
								<td><input type="text" id="add_chengben" name="addchengben"
									maxlength="12" readonly="readonly" autocomplete="off" />(元/张)</td>
							</tr>
							<tr>
								<td style="text-align: right; width: 200px">总利润：</td>
								<td><input type="text" id="add_lirun" maxlength="12"
									minlength="11" readonly="readonly" autocomplete="off" />(元)</td>
							</tr>
							<tr>
